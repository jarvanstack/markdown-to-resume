...
export const messages = {
  zh: {
    language: '语言', chinese: '中文', english: 'English', workspace: '工作区', editor: '编辑', preview: '预览', settings: '设置', loadingEditor: '正在加载编辑器...', resumeStats: '简历统计', characters: '字', minutes: '分钟', pages: '页', markdownEditor: 'Markdown 编辑器', cssEditor: 'CSS 编辑器', resetCss: '恢复当前主题 CSS',
    saveCustomTheme: '保存自定义主题', customSuffix: '自定义', exportFormat: '导出格式', image: '图片', exporting: '正在导出...', export: '导出', paperSize: '纸张尺寸', quickTemplates: '快速模板', moreTemplates: '更多模板', quickThemes: '快速主题', saveCurrentTheme: '保存当前主题', moreThemes: '更多主题', typography: '字体排版', resetTheme: '重置为主题配置', fitOnePage: '智能一页', fittingOnePage: '正在调整', fittedOnePage: '已适配一页', fitTooLong: '建议保留多页', fitTooShort: '已尽量撑满', font: '字体', fontSize: '正文字号', lineHeight: '行高', headingScale: '标题比例', spacing: '间距', layoutDensity: '排版密度', horizontalPadding: '左右页边距', verticalPadding: '上下页边距', sectionSpacing: '章节间距', colors: '颜色', heading: '标题', body: '正文', link: '链接', accent: '强调', muted: '次要信息',
    homeLabel: 'Markdown 简历编辑器首页', brand: 'Markdown简历', mainNavigation: '主导航', templates: '模板', themes: '主题', editorNav: '编辑器', openEditor: '打开编辑器', footer: '免费使用 · 数据仅保存在本地', download: '下载', downloaded: '已下载', renameCustomTheme: '重命名自定义主题', renamedTo: '已重命名为', deleteThemeConfirm: (name: string) => `删除自定义主题“${name}”？`, deleted: '已删除', imported: '已导入', importFailed: '主题导入失败', customThemeTagline: '保存在本地的自定义主题', resumeThemes: '简历主题', themeIntro: (count: number) => `${count} 套主题，支持智能一页，并可精细调整排版密度、字体、间距和颜色。`, importTheme: '导入主题', renameTheme: '重命名', deleteTheme: '删除', downloadCss: '下载 CSS', useTheme: '使用主题', resumeTemplates: '中文简历模板', templateIntro: (count: number) => `${count} 套中英文岗位模板，可直接载入编辑器，使用智能一页优化后导出。`, useTemplate: '使用模板', resumeDocumentTitle: '简历',
    ...
    templateGuidePoints: [
      ...
      { title: '智能一页后直接投递', text: '自动优化结构间距并实时检查 A4 或 Letter 分页，完成后导出 PDF，也可保存 PNG 或独立 HTML。' },
    ],
    templateFaqTitle: '简历模板常见问题', templateFaq: [
      { question: '这些中文简历模板可以免费使用吗？', answer: '可以。所有内置模板都能免费载入、编辑和导出，无需注册账号。' },
      { question: 'Markdown 简历可以导出 PDF 吗？', answer: '可以。编辑器会实时显示分页效果，可先用智能一页优化版面，再导出 A4 或 Letter 尺寸的 PDF。' },
    ...
    themeGuidePoints: [
      ...
      { title: '智能且精确地控制版面', text: '智能一页会优先优化结构间距，也可用连续密度滑杆调整字体、字号、行高、标题比例、章节间距和页边距。' },
    ...
    themeFaqTitle: '简历排版常见问题', themeFaq: [
      ...
      { question: '怎样把两页简历调整为一页？', answer: '先使用智能一页自动优化段落、标题和列表间距，再用排版密度、正文字号、行高、章节间距和页边距做精细调整。内容过长时会建议保留多页。' },
      { question: '自定义主题会丢失吗？', answer: '主题保存在当前浏览器中。需要跨设备使用时，可以下载 CSS 后在另一台设备导入。' },
    ],
  },
  en: {
    language: 'Language', chinese: '中文', english: 'English', workspace: 'Workspace', editor: 'Editor', preview: 'Preview', settings: 'Settings', loadingEditor: 'Loading editor...', resumeStats: 'Resume statistics', characters: 'chars', minutes: 'min', pages: 'pages', markdownEditor: 'Markdown editor', cssEditor: 'CSS editor', resetCss: 'Restore current theme CSS',
    saveCustomTheme: 'Save custom theme', customSuffix: 'Custom', exportFormat: 'Export format', image: 'Image', exporting: 'Exporting...', export: 'Export', paperSize: 'Paper size', quickTemplates: 'Quick templates', moreTemplates: 'More templates', quickThemes: 'Quick themes', saveCurrentTheme: 'Save current theme', moreThemes: 'More themes', typography: 'Typography', resetTheme: 'Reset to theme defaults', fitOnePage: 'Smart one-page', fittingOnePage: 'Fitting...', fittedOnePage: 'Fit complete', fitTooLong: 'Keep multiple pages', fitTooShort: 'Expanded', font: 'Font', fontSize: 'Body size', lineHeight: 'Line height', headingScale: 'Heading scale', spacing: 'Spacing', layoutDensity: 'Layout density', horizontalPadding: 'Horizontal margins', verticalPadding: 'Vertical margins', sectionSpacing: 'Section spacing', colors: 'Colors', heading: 'Heading', body: 'Body', link: 'Link', accent: 'Accent', muted: 'Muted text',
    homeLabel: 'Markdown Resume Editor home', brand: 'Markdown Resume', mainNavigation: 'Main navigation', templates: 'Templates', themes: 'Themes', editorNav: 'Editor', openEditor: 'Open editor', footer: 'Free to use · Data stays on this device', download: 'Download', downloaded: 'Downloaded', renameCustomTheme: 'Rename custom theme', renamedTo: 'Renamed to', deleteThemeConfirm: (name: string) => `Delete custom theme “${name}”?`, deleted: 'Deleted', imported: 'Imported', importFailed: 'Theme import failed', customThemeTagline: 'Custom theme saved on this device', resumeThemes: 'Resume themes', themeIntro: (count: number) => `${count} themes with Smart one-page fitting and precise density, typography, spacing, and color controls.`, importTheme: 'Import theme', renameTheme: 'Rename', deleteTheme: 'Delete', downloadCss: 'Download CSS', useTheme: 'Use theme', resumeTemplates: 'Resume templates', templateIntro: (count: number) => `${count} English and Chinese role templates, ready to edit, fit to one page, and export.`, useTemplate: 'Use template', resumeDocumentTitle: 'Resume',
    ...
    templateGuidePoints: [
      ...
      { title: 'Smart fitting, ready to submit', text: 'Optimize structural spacing, check A4 or Letter pagination live, then export PDF, PNG, or standalone HTML.' },
    ],
    templateFaqTitle: 'Resume template FAQ', templateFaq: [
      ...
      { question: 'Can a Markdown resume be exported to PDF?', answer: 'Yes. Preview every page live, use Smart one-page to optimize the layout, then export PDF in A4 or Letter format.' },
    ...
    themeGuidePoints: [
      ...
      { title: 'Smart, precise layout control', text: 'Smart one-page optimizes structural spacing first; a continuous density slider then fine-tunes type, line height, headings, sections, and margins.' },
    ...
    themeFaqTitle: 'Resume layout FAQ', themeFaq: [
      ...
      { question: 'How can I fit a two-page resume onto one page?', answer: 'Use Smart one-page to optimize paragraph, heading, and list spacing first, then fine-tune density, body size, line height, section spacing, and margins. It recommends multiple pages when the content is too long.' },
